...
import mail2clients.logger.service.LoggerService;
import mail2clients.rest.response.BuildResponse;
import mail2clients.rest.response.DataLog;
import mail2clients.rest.response.StatusEnum;
import mail2clients.util.EmailProperties;
import mail2clients.util.SMTPProperties;
import mail2clients.util.validator.EmailFields;
import java.util.*;
